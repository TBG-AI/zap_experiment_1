...
export function GameItem({ homeTeam, awayTeam, time, date, onGameSelect}) {
  ...
  return (
    <Card isHoverable isPressable allowTextSelectionOnPress className="w-[450px]" onPress={handlePress}>
      <CardBody className="flex">
        <div className="flex justify-center items-center ">
        <div className = "flex flex-none justify-between items-center w-20">
        <p className = "text-md text-right">{homeTeam}</p>
        </div>
        ...
        <div className = "flex flex-none justify-between items-center w-20">
        <p className = "text-md">{awayTeam}</p>
        </div>
        </div>
      </CardBody>
    </Card>
